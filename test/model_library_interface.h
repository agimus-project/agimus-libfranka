...
struct ModelLibraryInterface {
  ...
  virtual void Ji_J_J9(const double q[7], const double F_T_EE[16],
                       double b_Ji_J_J9[42]) = 0;

  virtual void M_NE(const double q[7], const double I_load[9], double m_load,
                    const double F_x_Cload[3], double M_NE[49]) = 0;
  ...
  virtual void O_J_J9(const double q[7], const double F_T_EE[16],
                      double b_O_J_J9[42]) = 0;
  ...
  virtual void O_T_J9(const double q[7], const double F_T_EE[16],
                      double b_O_T_J9[16]) = 0;

  virtual void c_NE(const double q[7], const double dq[7],
                    const double I_load[9], double m_load,
                    const double F_x_Cload[3], double c_NE[7]) = 0;

  virtual void g_NE(const double q[7], const double g_earth[3], double m_load,
                    const double F_x_Cload[3], double g_NE[7]) = 0;
};
