...
ControlException::ControlException(
    const std::string& what, std::vector<agimus_franka::Record> log) noexcept
...
IncompatibleVersionException::IncompatibleVersionException(
    ...
    : Exception(
          "libagimus_franka: Incompatible library version (server version: "s +
          std::to_string(server_version) + ", library version: "s +
          std::to_string(library_version) +
          "). Please check https://agimus_frankaemika.github.io for Panda "
          "system updates "
