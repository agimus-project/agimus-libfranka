...
Errors::Errors(
    const std::array<bool, 41>& errors)  // NOLINT(modernize-pass-by-value)
    : errors_(errors),
      joint_position_limits_violation(
          errors_[static_cast<size_t>(Error::kJointPositionLimitsViolation)]),
      cartesian_position_limits_violation(errors_[static_cast<size_t>(
          Error::kCartesianPositionLimitsViolation)]),
      self_collision_avoidance_violation(errors_[static_cast<size_t>(
          Error::kSelfcollisionAvoidanceViolation)]),
      joint_velocity_violation(
          errors_[static_cast<size_t>(Error::kJointVelocityViolation)]),
      ...
      cartesian_velocity_profile_safety_violation(errors_[static_cast<size_t>(
          Error::kCartesianVelocityProfileSafetyViolation)]),
      joint_position_motion_generator_start_pose_invalid(
          errors_[static_cast<size_t>(
              Error::kJointPositionMotionGeneratorStartPoseInvalid)]),
      joint_motion_generator_position_limits_violation(
          errors_[static_cast<size_t>(
              Error::kJointMotionGeneratorPositionLimitsViolation)]),
      joint_motion_generator_velocity_limits_violation(
          errors_[static_cast<size_t>(
              Error::kJointMotionGeneratorVelocityLimitsViolation)]),
      joint_motion_generator_velocity_discontinuity(errors_[static_cast<size_t>(
          Error::kJointMotionGeneratorVelocityDiscontinuity)]),
      joint_motion_generator_acceleration_discontinuity(
          errors_[static_cast<size_t>(
              Error::kJointMotionGeneratorAccelerationDiscontinuity)]),
      cartesian_position_motion_generator_start_pose_invalid(
          errors_[static_cast<size_t>(
              Error::kCartesianPositionMotionGeneratorStartPoseInvalid)]),
      cartesian_motion_generator_elbow_limit_violation(
          errors_[static_cast<size_t>(
              Error::kCartesianMotionGeneratorElbowLimitViolation)]),
      cartesian_motion_generator_velocity_limits_violation(
          errors_[static_cast<size_t>(
              Error::kCartesianMotionGeneratorVelocityLimitsViolation)]),
      cartesian_motion_generator_velocity_discontinuity(
          errors_[static_cast<size_t>(
              Error::kCartesianMotionGeneratorVelocityDiscontinuity)]),
      cartesian_motion_generator_acceleration_discontinuity(
          errors_[static_cast<size_t>(
              Error::kCartesianMotionGeneratorAccelerationDiscontinuity)]),
      cartesian_motion_generator_elbow_sign_inconsistent(
          errors_[static_cast<size_t>(
              Error::kCartesianMotionGeneratorElbowSignInconsistent)]),
      cartesian_motion_generator_start_elbow_invalid(
          errors_[static_cast<size_t>(
              Error::kCartesianMotionGeneratorStartElbowInvalid)]),
      ...
      cartesian_motion_generator_joint_velocity_discontinuity(
          errors_[static_cast<size_t>(
              Error::kCartesianMotionGeneratorJointVelocityDiscontinuity)]),
      ...
      cartesian_position_motion_generator_invalid_frame(
          errors_[static_cast<size_t>(
              Error::kCartesianPositionMotionGeneratorInvalidFrame)]),
      force_controller_desired_force_tolerance_violation(
          errors_[static_cast<size_t>(
              Error::kForceControllerDesiredForceToleranceViolation)]),
      ...
      communication_constraints_violation(errors_[static_cast<size_t>(
          Error::kCommunicationConstraintsViolation)]),
      power_limit_violation(
          errors_[static_cast<size_t>(Error::kPowerLimitViolation)]),
      joint_p2p_insufficient_torque_for_planning(errors_[static_cast<size_t>(
          Error::kJointP2PInsufficientTorqueForPlanning)]),
      tau_j_range_violation(
          errors_[static_cast<size_t>(Error::kTauJRangeViolation)]),
      instability_detected(
          errors_[static_cast<size_t>(Error::kInstabilityDetection)]),
      ...
      base_acceleration_initialization_timeout(errors_[static_cast<size_t>(
          Error::kBaseAccelerationInitializationTimeout)]),
      base_acceleration_invalid_reading(errors_[static_cast<size_t>(
          Error::kBaseAccelerationInvalidReading)]) {}
