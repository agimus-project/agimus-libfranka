...
class Robot::Impl : public RobotControl {
 public:
  explicit Impl(std::unique_ptr<Network> network, size_t log_size,
  ...
  RobotState update(
      ...
      const agimus_research_interface::robot::ControllerCommand*
          control_command) override;

  void throwOnMotionError(const RobotState& robot_state,
                          uint32_t motion_id) override;
  ...
  uint32_t startMotion(
      ...
      const agimus_research_interface::robot::Move::Deviation&
          maximum_goal_pose_deviation) override;
 ...
 private:
  ...
  template <typename T>
  using IsBaseOfGetterSetter = std::is_base_of<
      agimus_research_interface::robot::GetterSetterCommandBase<T, T::kCommand>,
      T>;
  ...
  std::enable_if_t<IsBaseOfGetterSetter<T>::value> handleCommandResponse(
    ...
    using namespace std::
        string_literals;  // NOLINT(google-build-using-namespace)
    ...
    switch (response.status) {
      ...
      case T::Status::kCommandNotPossibleRejected:
        throw CommandException(
            "libagimus_franka: "s +
            agimus_research_interface::robot::CommandTraits<T>::kName +
      ...
      //   agimus_research_interface::robot::CommandTraits<T>::kName +
      //                          " command rejected due to activated safety
      //                          function! Please disable " "all safety
      //                          functions. ");
      default:
  ...
  const RealtimeConfig
      realtime_config_;  // NOLINT(readability-identifier-naming)
  uint16_t ri_version_;

  agimus_research_interface::robot::RobotMode robot_mode_ =
      agimus_research_interface::robot::RobotMode::kOther;
  agimus_research_interface::robot::MotionGeneratorMode motion_generator_mode_;
  agimus_research_interface::robot::MotionGeneratorMode
...
template <>
inline void
Robot::Impl::handleCommandResponse<agimus_research_interface::robot::Move>(
  ...
  switch (response.status) {
      ...
      if (motionGeneratorRunning()) {
        throw ProtocolException(
            ...
            agimus_research_interface::robot::CommandTraits<
                agimus_research_interface::robot::Move>::kName +
    ...
    case agimus_research_interface::robot::Move::Status::
    ...
    case agimus_research_interface::robot::Move::Status::kAborted:
      throw CommandException(
          ...
          " command aborted!");
    // case
    // agimus_research_interface::robot::Move::Status::kPreemptedDueToActivatedSafetyFunctions:
    //  throw CommandException(
    //      "libagimus_franka: "s +
    //      agimus_research_interface::robot::CommandTraits<agimus_research_interface::robot::Move>::kName
    //      + " command preempted due to activated safety function! Please
    //      disable all safety " "functions.");
    // case
    // agimus_research_interface::robot::Move::Status::kCommandRejectedDueToActivatedSafetyFunctions:
    //   throw CommandException(
    //       "libagimus_franka: "s +
    //       agimus_research_interface::robot::CommandTraits<agimus_research_interface::robot::Move>::kName
    //       + " command rejected due to activated safety function! Please
    //       disable all safety " "functions.");
    default:
      throw ProtocolException(
          "libagimus_franka: Unexpected response while handling "s +
...
template <>
inline void
Robot::Impl::handleCommandResponse<agimus_research_interface::robot::StopMove>(
    const agimus_research_interface::robot::StopMove::Response& response)
    const {
  using namespace std::string_literals;  // NOLINT(google-build-using-namespace)
  ...
  switch (response.status) {
    case agimus_research_interface::robot::StopMove::Status::kSuccess:
      break;
    case agimus_research_interface::robot::StopMove::Status::
        kCommandNotPossibleRejected:
      throw CommandException(
          "libagimus_franka: "s +
          agimus_research_interface::robot::CommandTraits<
              agimus_research_interface::robot::StopMove>::kName +
          commandNotPossibleMsg());
    ...
    case agimus_research_interface::robot::StopMove::Status::kReflexAborted:
      throw CommandException(
          ...
          " command aborted: motion aborted by reflex!");
    // case
    // agimus_research_interface::robot::StopMove::Status::kCommandRejectedDueToActivatedSafetyFunctions:
    //   throw CommandException(
    //       "libagimus_franka: "s +
    //       agimus_research_interface::robot::CommandTraits<agimus_research_interface::robot::Move>::kName
    //       + " command rejected due to activated safety function! Please
...
template <>
inline void Robot::Impl::handleCommandResponse<
    agimus_research_interface::robot::AutomaticErrorRecovery>(
    const agimus_research_interface::robot::AutomaticErrorRecovery::Response&
        response) const {
  using namespace std::string_literals;  // NOLINT(google-build-using-namespace)
...
uint32_t Robot::Impl::executeCommand(TArgs... args) {
  ...
  typename T::Response response =
      network_->tcpBlockingReceiveResponse<T>(command_id);
