 ...
 * An example showing how to generate a joint position motion with an external
 * control loop..
 *
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    auto control_callback =
      ...
      agimus_franka::JointPositions output = {
    ...
    auto active_control =
        robot.startJointPositionControl(agimus_research_interface::robot::Move::
