 ...
 * An example showing a simple cartesian impedance controller without inertia
 * shaping that renders a spring damper system where the equilibrium is the
 * initial configuration. After starting the controller try to push the robot
 * around and try different stiffness levels.
 *
 * @warning collision thresholds are set to high values. Make sure you have the
 * user stop at hand!
 */
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    std::cout << "WARNING: Collision thresholds are set to high values. "
              ...
              << "After starting try to push the robot and see how it reacts."
              << std::endl
